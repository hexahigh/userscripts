...
(function () {
  ...
  const lenis = new Lenis({
    autoRaf: true,
    autoToggle: true, // Doesn't work on older browsers
    allowNestedScroll: true, // Can cause performance issues, but is essentially needed since we are trying to use Lenis everywhere
    prevent: (node) =>
